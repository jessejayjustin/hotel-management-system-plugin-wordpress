    ...
    <div id="portfolio">
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    <?php 
                    global $wpdb;
                    $qry = $wpdb->get_results("SELECT * FROM wp_room_categories order by rand()", ARRAY_A);
                    foreach ($qry as $row) {
                    ?>  
                        <div class='col-lg-4 col-sm-6'>
                            <a class='portfolio-box' href='#'>
                                <img class='img-fluid' src='http://localhost/wordpress/wp-content/plugins/hotel-booking/assets/img/<?php echo $row['cover_img'] ?>' /> 
